...
class MyBase(Dataset):
    def __init__(self,data_paths,data_modes):
        super().__init__()
        data_dict={data_path for data_path in data_paths.split(',') if ',' in data_paths else [data_paths] ,datamode for data_path in data_paths.split(',') if ',' in data_modes else [data_modes  }
        self.data_paths=data_paths.split(',') if ',' in data_paths else [data_paths]
